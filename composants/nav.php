<?php
$same = 'rounded-md px-3 py-2 text-sm font-medium text-white';
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img class="size-8" src="assets/images/ESPACESIS.png" alt="Your Company">
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              ?>
              <a href="index.php" class="<?php echo ($page === "index.php" )? $current : $default?>">accueil</a>
              <a href="produits.php" class="<?php echo ($page=="produits.php")? $current :$default?>">Produits</a>
              <a href="filtre.php" class="<?php echo ($page=="filtre.php")? $current :$default?>">filtre</a>

              <?php if($_SESSION['user'] ?? false): ?>

              <a href="create.php" class="<?php echo ($page=="create.php")? $current :$default?>">nouveau produit</a>

              <?php endif; ?>
              <a href="about.php" class="<?php echo ($page=="about.php")? $current :$default?>">about</a>
              <a href="contact.php" class="<?php echo ($page=="contact.php")? $current :$default?>">Contacts</a>
            </div>
          </div>
        </div>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <button href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">
                  Se déconnecter
                </button>
                </form>
